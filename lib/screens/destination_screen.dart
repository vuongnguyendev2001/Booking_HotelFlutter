        ...
        children: [
          Stack(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(top: 280, left: 10, right: 15),
                child: Row(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Text(
                          'Nhận phòng: ' + widget.documentSnapshot['checkIn'],
                          style: TextStyle(
                            color: Colors.black,
                            fontSize: 18,
                        ...
                        Text(
                          'Trả phòng: ' + widget.documentSnapshot['checkOut'],
                          style: TextStyle(
                            color: Colors.black,
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
          ...
          GestureDetector(
            onTap: () => Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    booknow_Screen(documentSnapshot: widget.documentSnapshot),
              ),
            ),
            child: Padding(
