...
class _myorder_ScreenState extends State<myorder_Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            SizedBox(width: 60,),
              Text('PHÒNG ĐÃ ĐẶT', style: TextStyle(
              color: Colors.black,
              fontSize: 22,
      ...
      body: StreamBuilder(
        stream: _booking.collection('booking').orderBy('DateTimebooking', descending: true).snapshots(),
        builder: (context, AsyncSnapshot<QuerySnapshot> document){
          if(!document.hasData) return Center(
            child: Text('erorr'),
          );
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Text(formattedDate(documentSnapshot['startDate']),style: TextStyle(
                                        fontSize: 20,
                                        fontWeight: FontWeight.bold,
                                      ),),
                                      SizedBox(width: 10,),
                                      ...
                                      SizedBox(width: 10,),
                                      Text(formattedDate(documentSnapshot['endDate']),style: TextStyle(
                                        fontSize: 20,
                                        fontWeight: FontWeight.bold,
                                      ),),
                                    ],
                                  ...
                                  SizedBox(height: 2,),
                                  Text(documentSnapshot['addressHotel'],style: TextStyle(
                                    fontSize: 18,
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text('Ngày đặt: '+ formattedDatebook(documentSnapshot['DateTimebooking'],),
                                      style: TextStyle(
                                        fontSize: 18,
                                        fontWeight: FontWeight.w500,
                                      ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text('đ'+documentSnapshot['price'],style: TextStyle(
                                        fontSize: 20,
                                        fontWeight: FontWeight.w600,
                                      ),),
                                    ],
